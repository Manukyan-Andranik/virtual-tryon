...
class UNet2DConditionModel(ModelMixin, ConfigMixin, UNet2DConditionLoadersMixin):
    ...
    def set_attn_processor(self, processor: Union[AttentionProcessor, Dict[str, AttentionProcessor]]): #       self, processor: Union[AttentionProcessor, Dict[str, AttentionProcessor]], _remove_lora=False):
        r"""
    ...
    def forward(
        ...
        for downsample_block in self.down_blocks:
            if hasattr(downsample_block, "has_cross_attention") and downsample_block.has_cross_attention:
                ...
                print(f"-----------/api/vto-dress/./base/unet_hacked_tryon.py type of garment_features {garment_features[0]} is: {type(garment_features)}")
